  ...
  },
  {
    ...
    renderLogo: () => (
      <svg width="20" height="20" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
        ...
        {/* Bottom - Yellow */}
        <path d="M8.545 7.705l-3.959 4.707c.724 1.54 1.821 2.863 2.871 4.18.247.31.494.622.737.936l4.984-5.925-.029.01c-1.741.601-3.691-.291-4.392-1.987a3.377 3.377 0 0 1-.209-.716c-.063-.437-.077-.761-.004-1.198l.001-.007z" fill="#FBBC05" />
        {/* Left - Blue */}
        <path d="M5.492 3.149l-.003.004c-1.947 2.466-2.281 5.88-1.117 8.77l4.785-5.689-.058-.05-3.607-3.035z" fill="#4285F4" />
        {/* Top Right - Red */}
        <path d="M14.661.436l-3.838 4.563a.295.295 0 0 1 .027-.01c1.6-.551 3.403.15 4.22 1.626.176.319.323.683.377 1.045.068.446.085.773.012 1.22l-.003.016 3.836-4.561A8.382 8.382 0 0 0 14.67.439l-.009-.003z" fill="#EA4335" />
        {/* Top Left - Red */}
        <path d="M9.466 5.868L14.162.285l-.047-.012A8.31 8.31 0 0 0 11.986 0a8.439 8.439 0 0 0-6.169 2.766l-.016.018 3.665 3.084z" fill="#EA4335" />
      </svg>
    ),
    color: '#EA4335',
    tag: 'LOCAL SEO'
  ...
  },
  {
    ...
    renderLogo: () => (
      <svg width="24" height="24" viewBox="0 0 100 100" fill="none" style={{ flexShrink: 0 }}>
        <path d="M36 70 V30 C36 24, 40 20, 46 22.5 L68 34.5 C74 37.5, 74 45.5, 68 48.5 L46 61" stroke="#3B14A6" strokeWidth="6.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M48 20 L70 32 C76 35, 76 43, 70 46 L48 58 C42 61, 38 57, 38 51 V30" stroke="#7C2BE8" strokeWidth="6.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M38 50 V70 C38 76, 42 80, 48 77.5 L70 65.5 C76 62.5, 76 54.5, 70 51.5 L48 39" stroke="#64D2FF" strokeWidth="6.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      >
        ...
        >
          {list.map((partner, index) => (
            ...
            >
              <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: partner.color, transition: 'color var(--transition-fast)', width: '24px', height: '24px', flexShrink: 0 }} className="partner-svg-logo">
                {partner.renderLogo()}
              </span>
